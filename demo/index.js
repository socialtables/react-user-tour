 	...
 	render() {
		...
		return (
			<div>
				...
				Habeo choro nec in. Prima conclusionemque est ei, ne eam graeco adipisci. Detraxit abhorreant vel te. <span className="dolores" style={{color: "yellow"}}>Dolores</span> deterruisset in quo.
